...
public class AVLTree {
   ...
   //FIND METHOD. Returns true if the given value is found in the tree.
   ...
   //REMOVE METHOD. Remove a node from the tree if it exists
   ...
   public AVLNode successor(AVLNode x) {
	...
	public static void main(String[] args) {
		...
		while (true) {
         ...
         System.out.println("4-Find a number in the tree");
            ...
            case 4:
               ...
               value = Integer.parseInt(inputReader.readLine());
               if(tree.find(tree.rootnode, value)) {
